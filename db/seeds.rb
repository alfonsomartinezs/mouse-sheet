...
city_names = [
  {name:"Barkstone",  description:"A busy working-class town.",skill_list:"carpenter,potter,glazier",trait_list:"steady paw"},
  {name:"Copperwood", description:"One of the oldest cities and home to one of the two mines in the territories.",skill_list:"smith,haggler",trait_list:"independent"},
  {name:"Elmoss",     description:"A once thriving city known for its medicinal moss",skill_list:"carpenter,harvester",trait_list:"alert"},
  {name:"Ivydale",    description:"Renowned for its bakers and breads.",skill_list:"harvester,baker",trait_list:"hard worker"},
  {name:"Lockhaven",  description:"The home of the Mouse Guard.",skill_list:"weaver,armorer",trait_list:"generous,guard's honor"},
  {name:"Port Sumac", description:"A busy little port town between Darkwater and Rustleaf.",skill_list:"boatcrafter,weather watcher",trait_list:"tough,weather sense"},
  {name:"Shaleburrow",description:"A simple town known for its delicious drinks!",skill_list:"mason,harvester,miller",trait_list:"open-minded"},
  {name:"Sprucetuck", description:"Known for its scientists, medicine and scent concoctions.",skill_list:"scientist,loremouse",trait_list:"inquisitive,rational"}
  # ,
  # {name:"Appleloft",  description:"",skill_list:"",trait_link:""},
  # {name:"Blackrock",  description:"",skill_list:"",trait_link:""},
  # {name:"Butterloch", description:"",skill_list:"",trait_link:""},
  # {name:"Calogero",   description:"",skill_list:"",trait_link:""},
  # {name:"Darkwater",  description:"",skill_list:"",trait_link:""},
  # {name:"Dorigift",   description:"",skill_list:"",trait_link:""},
  # {name:"Flintrust",  description:"",skill_list:"",trait_link:""},
  # {name:"Frostic",    description:"",skill_list:"",trait_link:""},
  # {name:"Gilpledge",  description:"",skill_list:"",trait_link:""},
  # {name:"Ironwood",   description:"",skill_list:"",trait_link:""},
  # {name:"Mapleharber",description:"",skill_list:"",trait_link:""},
  # {name:"Pebblebrook",description:"",skill_list:"",trait_link:""},
  # {name:"Rootwallow", description:"",skill_list:"",trait_link:""},
  # {name:"Rustleaf",   description:"",skill_list:"",trait_link:""},
  # {name:"Sandmason",  description:"",skill_list:"",trait_link:""},
  # {name:"Shorestone", description:"",skill_list:"",trait_link:""},
  # {name:"Windselm",   description:"",skill_list:"",trait_link:""},
  # {name:"Wolfepointe",description:"",skill_list:"",trait_link:""}
]
